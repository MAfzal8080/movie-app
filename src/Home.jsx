...
const Home = () => {
    ...
    // const image = 'https://code.4noobz.net/wp-content/uploads/2018/10/OMDB-API.png'
    ...
    useEffect(() => {
      ...
      const fetchMovie = async () =>{
        const url = `https://omdbapi.com/?s=marvel&apikey=f4c9a0d7`
        const movies = await axios.get(url)
        setMovie(movies.data.Search)
      }

    const fetchMore = async ()=>{
      const url = `https://omdbapi.com/?s=marvel&page=${page}&apikey=f4c9a0d7`
  ...
  return (
    ...
    {moreMovie && moreMovie.map((data, idx)=>{
        return (
